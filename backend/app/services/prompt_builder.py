...
- final_text: 2-3문단의 짧은 한국어 풀이. 첫 문장은 사용자의 고민에 대한 직접 답이어야 한다. 이후에는 사주 용어를 넣고 괄호나 이어지는 문장으로 쉬운 뜻을 풀어, 심리 해석, 명식 근거, 행동 기준을 압축해 쓴다.
- summary_cards: 정확히 4개. title은 순서대로 "현재 핵심", "타고난 기질", "운의 흐름", "결정 기준"을 사용한다. headline은 짧은 결론, body는 쉬운 설명을 쓴다.
- deep_sections: 정확히 4개. title은 순서대로 "지금의 마음", "사주 기질", "시기 흐름", "고민에 대한 답"을 사용한다. 각 body는 2-4문장으로 쓰고, "사주 기질"과 "고민에 대한 답"에는 실제 사주 용어와 쉬운 번역을 함께 넣는다.
